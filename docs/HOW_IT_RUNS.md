...
Today GameCrate ships as one file:
...
| Piece | Role |
|---|---|
| **gamecrate.exe** | User-facing launcher — profiles, ACL setup, spawn game |
...
| Location | Contents |
|---|---|
| `gamecrate.exe` | The launcher (you choose where — e.g. `C:\Tools\GameCrate\`) |
